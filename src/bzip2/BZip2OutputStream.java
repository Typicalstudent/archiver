...
public class BZip2OutputStream extends OutputStream implements BZip2Constants {
    ...
    private bzip2.BZip2OutputStream.Data data;
    ...
    private static void hbMakeCodeLengths(byte[] len, int[] freq, bzip2.BZip2OutputStream.Data dat, int alphaSize, int maxLen) {
        int[] heap = dat.heap;
    ...
    private void writeRun() throws IOException {
        ...
        if (lastShadow < this.allowableBlockSize) {
            ...
            bzip2.BZip2OutputStream.Data dataShadow = this.data;
    ...
    private void init() throws IOException {
        this.data = new bzip2.BZip2OutputStream.Data(this.blockSize100k);
        this.bsPutUByte(104);
    ...
    private boolean mainSimpleSort(bzip2.BZip2OutputStream.Data dataShadow, int lo, int hi, int d) {
        int bigN = hi - lo + 1;
        if (bigN < 2) {
    ...
    private void mainQSort3(bzip2.BZip2OutputStream.Data dataShadow, int loSt, int hiSt, int dSt) {
